...
const extra = [
  [
    "frankenstein-yazari",
    "Frankenstein romanının yazarı kimdir?",
  ...
  [
    "foundation-yazar",
    "Foundation serisinin yazarı kimdir?",
    "Who wrote the Foundation series?",
    "Isaac Asimov",
    ["Ray Bradbury", "Robert Heinlein", "William Gibson"],
  ],
  [
    "neuromancer-yazar",
    "Neuromancer romanının yazarı kimdir?",
    "Who wrote Neuromancer?",
    "William Gibson",
    ["Neal Stephenson", "Orson Scott Card", "Kurt Vonnegut"],
  ],
  [
    "star-trek-yaratici",
    "Star Trek evreninin yaratıcısı kimdir?",
    "Who created Star Trek?",
    "Gene Roddenberry",
    ["George Lucas", "J. J. Abrams", "Ridley Scott"],
  ],
  [
    "doctor-who-gezegen",
    "Doctor Who’da Doktor’un ana gezegeninin adı nedir?",
    "What is the Doctor’s home planet in Doctor Who?",
    "Gallifrey",
    ["Krypton", "Vulcan", "Arrakis"],
  ],
  [
    "blade-runner-yazar",
    "Blade Runner’ın uyarlandığı romanı yazan kişi kimdir?",
    "Who wrote the novel adapted as Blade Runner?",
    "Philip K. Dick",
    ["Frank Herbert", "Stanislaw Lem", "H. G. Wells"],
  ],
  [
    "war-worlds-yazar",
    "Dünyalar Savaşı romanının yazarı kimdir?",
    "Who wrote The War of the Worlds?",
    "H. G. Wells",
    ["Jules Verne", "Mary Shelley", "Ray Bradbury"],
  ],
];
