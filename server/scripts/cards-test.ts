...
test("tur başına bir kart: ikinci kullanım reddedilir", () => {
  ...
  assert.throws(
    () => r.useCard("a", "shield"),
    (e) => e instanceof GameError && e.key === "err.cardUsed",
  );
});
...
test("cevap kilitlendikten sonra err.cardLate", () => {
  ...
  assert.throws(
    () => r.useCard("a", "fifty"),
    (e) => e instanceof GameError && e.key === "err.cardLate",
  );
});
...
test("kartlar yalnız Klasik/Takım: Çember modunda err.cardMode", () => {
  ...
  assert.throws(
    () => r.useCard("a", "fifty"),
    (e) => e instanceof GameError && e.key === "err.cardMode",
  );
});
...
test("soru dışı fazda err.cardPhase", () => {
  ...
  assert.throws(
    () => r.useCard("a", "fifty"),
    (e) => e instanceof GameError && e.key === "err.cardPhase",
  );
});
