...
export function PodiumCharacter() {
  const [enabled] = useState(() => typeof matchMedia !== 'function' || matchMedia(`(min-height: ${MODEL_MIN_HEIGHT}px)`).matches)
  ...
  return <div className="qt-podium-model-slot" aria-hidden="true">{ready && <model-viewer
